...
function App() {
  ...
  return <>
    <div className="page-shell">
      <header className="masthead"><a className="wordmark" href="https://gtmgrace.com" target="_blank" rel="noopener noreferrer" aria-label="GTM Grace website">gtm<span>grace</span><b>✳</b></a><span className="masthead-label">WEBSITE INTELLIGENCE</span><span className="edition">FIELD NOTES / {report.generated_at.slice(0,4)}</span></header>
      <main>
      ...
      <footer className="signature"><div><span className="eyebrow">A little research. A better starting point.</span><p>Made with perspective.</p></div><a href="https://gtmgrace.com" target="_blank" rel="noopener noreferrer"><span>by Grace</span><strong>gtmgrace.com <b aria-hidden="true">↗</b></strong></a></footer>
    </div>
  </>;
}
