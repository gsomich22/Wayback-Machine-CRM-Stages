...
import {normalizeReport, summarize} from './report-data.mjs';
...
if (process.argv[1] && resolve(process.argv[1]) === fileURLToPath(import.meta.url)) {
  try {
    ...
    const html = renderReport(JSON.parse(readFileSync(resolve(args[0]), 'utf8')));
